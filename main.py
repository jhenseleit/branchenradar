...
BILDPROMPT_DEFAULT = (
    ...
    '• BERUFLICH (Skyport, Vertrieb, Handel, Branche): Sein ECHTER Arbeitsplatz ist ein helles, modernes '
    'BÜRO-/Vertriebsumfeld – am Schreibtisch mit Laptop, im Meetingraum, im Gespräch mit Team oder Kunden, '
    'am Telefon, vor einem Bildschirm mit Zahlen/Übersicht, an einer Ideenwand. Eine Logistik-/Lagerhalle '
    'NUR verwenden, wenn das Thema wirklich um Logistik, Versand, Lieferzeit oder Lager geht – und dann '
    'höchstens als Hintergrund, nicht als sein Arbeitsplatz. Die Szene soll den Kern des Themas '
    'widerspiegeln. Outfit (Signature-Look): dunkelblaues Sakko ODER dunkelblaue Bomberjacke über einem '
    'sauberen weißen Rundhals-T-Shirt, gut sitzend – KEIN klassisches Hemd.\n'
    '• PRIVAT/GESELLSCHAFTLICH (Familie, Ehrenamt/Sportverein, Gemeinderat/Kommunales, mentale '
    'Gesundheit, Gemeinschaft, Work-Life-Balance): eine authentische, zum Thema passende Umgebung '
    'AUSSERHALB des Büros – z. B. am Sportplatz oder Vereinsheim, draußen in der Natur der Oberpfalz, in '
    'einem gemeinschaftlichen/ehrenamtlichen Umfeld. Outfit gepflegt-lässig (z. B. schlichter Pullover '
    'oder Strick, Freizeitjacke, Jeans) – ruhig, nahbar, echt; hier KEIN Sakko und kein Büro erzwingen.\n\n'
