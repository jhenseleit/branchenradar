...
_TONREGELN = ('Kein Berater- oder Motivationssprech, keine Floskeln, keine Emojis, keine Dreierfiguren als '
              ...
              'Konzept, aber auch nicht dagegen schießen. '
              'Der Text darf und SOLL eine klare Haltung einnehmen und zuspitzen bzw. polarisieren – '
              'Reibung ist erwünscht, brav und glattgebügelt ist es nicht. Rote Linien dabei: keine '
              'Parteipolitik, keine Religion, keine persönlichen Angriffe; Kritik ist erlaubt, aber nie '
              'persönlich oder emotional aufgeladen. '
              'Zahlen: Skyport-EIGENE Kennzahlen aus dem Profil (z. B. Lieferquote, Sortimentsgröße) direkt '
              'und selbstbewusst verwenden – OHNE Zusätze wie „(eigene Angabe)" oder „laut eigenen '
              'Angaben". Externe Zahlen nur, wenn sie in der Faktengrundlage belegt sind, dann knapp die '
              'Quelle nennen. Erfinde keine Zahlen.')
...
PRUEFER_DEFAULT = (
    ...
    'Zusatz wie „(eigene Angabe)"; steht so ein Zusatz drin, kritisiere ihn als überflüssig. (2) '
    'Tonverstöße: Emojis, Floskeln, Beratersprech, Dreierfiguren, die Aussage „ausschließlich über '
