...
BILDPROMPT_DEFAULT = (
    ...
    'aufgeräumte Logistik-/Möbelhalle mit leichtem Themenbezug (Stehpult, Packtisch, Regalreihen, '
    'Verladetor). Outfit (Signature-Look): dunkelblaues Sakko ODER dunkelblaue Bomberjacke über einem '
